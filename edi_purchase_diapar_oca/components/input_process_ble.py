...
class EDIInputProcessDiaparDespatchAdvice(models.AbstractModel):
    ...
    @property
    def msg_despatch_processed(self):
        return self.env._("Stock Picking %s updated")
    ...
    def _get_picking_order_and_supplier_info(
        ...
        if picking_order:
            return picking_order, supplier_info
    ...
    def _get_updated_quantity_values(
        ...
        ordered_quantity = ordered_operation.product_qty
    ...
    def _prepare_picking_update_values(self, exchange_record):
        ...
        for line in lines:
            ...
            if line[0] == edi_exchange_type.header_code and not delivery_date:
                # Header processing
                delivery_date = self._reprepare_delivery_date(line, edi_exchange_type)
            elif line[0] == edi_exchange_type.lines_code:
