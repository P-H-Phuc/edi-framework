    ...
    for code in EXCHANGE_CODES:
        ...
        if code == "diapar_out_order":
            exchange_type_data.update(
                {
                    "direction": "output",
                    "exchange_filename_pattern": "LD{record.env['edi.configuration'].get_datenow_format_for_file()[0]}H['edi.configuration'].get_datenow_format_for_file()[1].C99",  # noqa: E501
